...
static int SIM_buf_set_para(SIM_power_array_info_t *info, int is_fifo, u_int n_read_port, u_int n_write_port, u_int n_entry, u_int line_width, int outdrv)
{
  /* ==================== set parameters ==================== */
  /* general parameters */
  info->share_rw = 0;
...
inline int FUNC(SIM_buf_power_data_write, SIM_power_array_info_t *info, SIM_power_array_t *arr, u_char *data_line, u_char *old_data, u_char *new_data)
{
